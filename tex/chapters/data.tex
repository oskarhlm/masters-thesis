...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{p{3cm}|p{3cm}|X}
        ...
        \midrule
        Buildings         & Polygon            & Dataset containing building polygons. Its \emph{type} attribute can have values like \emph{house}, \emph{university}, and \emph{restaurant}.                                                                  \\
        \midrule
        Land Use          & Polygon            & Representing areas designated to different purposes and activities. Its \emph{fclass} attribute that can have values like \emph{forest}, \emph{farmland}, and \emph{residential}.                             \\
        \midrule
        Natural           & Point              & Dataset containing polygons representing areas designated to different purposes and activities. Its \emph{fclass} attribute that can have values like \emph{forest}, \emph{farmland}, and \emph{residential}. \\
        \midrule
        Natural           & Polygon            &                                                                                                                                                                                                               \\
        \midrule
        Places of Worship & Point              &                                                                                                                                                                                                               \\
        \midrule
