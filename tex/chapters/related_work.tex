...
\begin{itshape}
    NB! \Autosubsectionref{sec:llm-gis} in this chapter reused material (with some minor modifications) from the specialization project \citep{holmLLMsDeathGIS2023} that preceded this master's thesis.
\end{itshape}

\vspace{12pt}

This chapter provides an overview of previous research that shares objectives similar to those of this thesis. The related work is divided into two main parts: \autoref{sec:llm-gis}, which presents research investigating potential use cases of \acrshortpl{acr:llm} in the field of geospatial information technology; and \autoref{sec:agent-patterns}, which presents examples of three different types of patterns commonly used in \acrshort{acr:llm}-based agents.
